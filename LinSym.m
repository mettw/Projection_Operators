classdef LinSym
    ...
    methods
        function obj = LinSym(Pxy, Pab, Plr)
            obj.U = [Pxy.basis("E_11") Pxy.basis("E_22") ...
                Pab.basis("E_11") Pab.basis("E_22") ...
                Plr.basis("E_11") Plr.basis("E_22")];
            obj.U = sparse(obj.U);

            obj.size_xy_E_11 = size(Pxy.basis("E_11"),2);
            obj.size_xy_E_22 = size(Pxy.basis("E_22"),2);
            obj.size_ab_E_11 = size(Pab.basis("E_11"),2);
            obj.size_ab_E_22 = size(Pab.basis("E_22"),2);
        ...
        function sigma = get_linear_symmetry(obj, vec)
            ...
            base = 0;
            sigma_0 = sym_vec(base+1:base+obj.size_xy_E_11)'*sym_vec(base+1:base+obj.size_xy_E_11);
            sigma_1 = sigma_0;
            base = base+obj.size_xy_E_11;
            sigma_0 = sigma_0 + sym_vec(base+1:base+obj.size_xy_E_22)'*sym_vec(base+1:base+obj.size_xy_E_22);
            sigma_1 = sigma_1 - sym_vec(base+1:base+obj.size_xy_E_22)'*sym_vec(base+1:base+obj.size_xy_E_22);

            base = base + obj.size_xy_E_22;
            sigma_2 = sym_vec(base+1:base+obj.size_ab_E_11)'*sym_vec(base+1:base+obj.size_ab_E_11);
            base = base+obj.size_ab_E_11;
            sigma_2 = sigma_2 - sym_vec(base+1:base+obj.size_ab_E_22)'*sym_vec(base+1:base+obj.size_ab_E_22);

            base = base+obj.size_ab_E_22;
        ...
        function sigma = get_linear_symmetry_xy(obj, vec)
            sym_vec = obj.U'*vec;

            base = 0;
            sigma_x = sym_vec(base+1:base+obj.size_xy_E_11)'*sym_vec(base+1:base+obj.size_xy_E_11);
            base = base+obj.size_xy_E_11;
            sigma_y = sym_vec(base+1:base+obj.size_xy_E_22)'*sym_vec(base+1:base+obj.size_xy_E_22);

            base = base + obj.size_xy_E_22;
            sigma_d = sym_vec(base+1:base+obj.size_ab_E_11)'*sym_vec(base+1:base+obj.size_ab_E_11);
            base = base+obj.size_ab_E_11;
            sigma_a = sym_vec(base+1:base+obj.size_ab_E_22)'*sym_vec(base+1:base+obj.size_ab_E_22);

            base = base+obj.size_ab_E_22;
            sigma_p = sym_vec(base+1:base+obj.size_lr_E_11)'*sym_vec(base+1:base+obj.size_lr_E_11);
            base = base+obj.size_lr_E_11;
            sigma_m = sym_vec(base+1:base+obj.size_lr_E_22)'*sym_vec(base+1:base+obj.size_lr_E_22);

            sigma = [sigma_x sigma_y sigma_d sigma_a sigma_p sigma_m]/(vec'*vec);
        end
        ...
        function sigma = get_linear_symmetry_field(obj, field)
            ...
            base = 0;
            sigma_0_x = sym_vec_x(base+1:base+obj.size_xy_E_11)'*sym_vec_x(base+1:base+obj.size_xy_E_11);
            sigma_1_x = sigma_0_x;

            sigma_0_z = sym_vec_z(base+1:base+obj.size_xy_E_11)'*sym_vec_z(base+1:base+obj.size_xy_E_11);
            sigma_1_z = sigma_0_z;
            sigma_0_y = sym_vec_y(base+1:base+obj.size_xy_E_11)'*sym_vec_y(base+1:base+obj.size_xy_E_11);
            sigma_1_y = sigma_0_y;
            base = base+obj.size_xy_E_11;
            sigma_0_x = sigma_0_x + sym_vec_x(base+1:base+obj.size_xy_E_22)'*sym_vec_x(base+1:base+obj.size_xy_E_22);
            sigma_1_x = sigma_1_x - sym_vec_x(base+1:base+obj.size_xy_E_22)'*sym_vec_x(base+1:base+obj.size_xy_E_22);

            sigma_0_z = sigma_0_z + sym_vec_z(base+1:base+obj.size_xy_E_22)'*sym_vec_z(base+1:base+obj.size_xy_E_22);
            sigma_1_z = sigma_1_z - sym_vec_z(base+1:base+obj.size_xy_E_22)'*sym_vec_z(base+1:base+obj.size_xy_E_22);

            sigma_0_y = sigma_0_y + sym_vec_y(base+1:base+obj.size_xy_E_22)'*sym_vec_y(base+1:base+obj.size_xy_E_22);
            sigma_1_y = sigma_1_y - sym_vec_y(base+1:base+obj.size_xy_E_22)'*sym_vec_y(base+1:base+obj.size_xy_E_22);

            base = base + obj.size_xy_E_22;
            sigma_2_x = sym_vec_x(base+1:base+obj.size_ab_E_11)'*sym_vec_x(base+1:base+obj.size_ab_E_11);
            sigma_2_z = sym_vec_z(base+1:base+obj.size_ab_E_11)'*sym_vec_z(base+1:base+obj.size_ab_E_11);
            sigma_2_y = sym_vec_y(base+1:base+obj.size_ab_E_11)'*sym_vec_y(base+1:base+obj.size_ab_E_11);
            base = base+obj.size_ab_E_11;
            sigma_2_x = sigma_2_x - sym_vec_x(base+1:base+obj.size_ab_E_22)'*sym_vec_x(base+1:base+obj.size_ab_E_22);
            sigma_2_z = sigma_2_z - sym_vec_z(base+1:base+obj.size_ab_E_22)'*sym_vec_z(base+1:base+obj.size_ab_E_22);
            sigma_2_y = sigma_2_y - sym_vec_y(base+1:base+obj.size_ab_E_22)'*sym_vec_y(base+1:base+obj.size_ab_E_22);
        ...
        function sigma = get_linear_symmetry_orig(obj, vec)
            base = 0;
            A = obj.U(:,base+1:base+obj.size_xy_E_11);
            sym_vec = (vec'*A)*(A'*vec);
            sigma_0 = sym_vec;
            sigma_1 = sym_vec;
            base = base+obj.size_xy_E_11;
            A = obj.U(:,base+1:base+obj.size_xy_E_22);
            sym_vec = (vec'*A)*(A'*vec);
            sigma_0 = sigma_0 + sym_vec;
            sigma_1 = sigma_1 - sym_vec;

            base = base + obj.size_xy_E_22;
            A = obj.U(:,base+1:base+obj.size_ab_E_11);
            sigma_2 = (vec'*A)*(A'*vec);
            base = base+obj.size_ab_E_11;
            A = obj.U(:,base+1:base+obj.size_ab_E_22);
