        ...
        function out = shift(obj, varargin)
            ...
            switch nargin
                ...
                otherwise
                    ...
                    if shift_y < 0
                        shift_y = -shift_y;
                        Ex_shifted = [obj.Ex(end-shift_y+1:end-1,:); ...
                            obj.Ex(1:end-shift_y+1,:)];
                        Ey_shifted = [obj.Ey(end-shift_y+1:end-1,:); ...
                            obj.Ey(1:end-shift_y+1,:)];
                        Ez_shifted = [obj.Ez(end-shift_y+1:end-1,:); ...
                            obj.Ez(1:end-shift_y+1,:)];
                    else
                        Ex_shifted = [obj.Ex(shift_y+1:end-1,:); ...
                            obj.Ex(1:shift_y+1,:)];
                        Ey_shifted = [obj.Ey(shift_y+1:end-1,:); ...
                            obj.Ey(1:shift_y+1,:)];
                        Ez_shifted = [obj.Ez(shift_y+1:end-1,:); ...
                            obj.Ez(1:shift_y+1,:)];
                    end
                    %Ex_shifted = [Ex_shifted(((obj.size_y-1)/2-1)/2+1:end-1,:); ...
                    %    Ex_shifted(1:((obj.size_y-1)/2-1)/2+1,:)];
